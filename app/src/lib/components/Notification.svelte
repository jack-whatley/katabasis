<script lang="ts">
    import { NotificationModel, getNotificationColour } from "$lib/utils/notification";

    let { notification, clickCallback }: { notification: NotificationModel, clickCallback: () => void } = $props();
